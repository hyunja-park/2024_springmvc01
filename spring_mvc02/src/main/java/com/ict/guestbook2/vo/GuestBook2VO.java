...
public class GuestBook2VO {
	// DB 컬럼과 같아야 한다.
	private String gb2_idx, gb2_name, gb2_subject, gb2_content, gb2_email, gb2_f_name, odd_f_name, gb2_regdate, gb2_pw;
	...
	public void setOdd_f_name(String odd_f_name) {
		this.odd_f_name = odd_f_name;
	}
